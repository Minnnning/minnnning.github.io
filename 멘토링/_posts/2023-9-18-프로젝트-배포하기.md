---
layout: post
image: "https://github.com/Minnnning/minnnning.github.io/assets/80758613/cf7923c0-9369-40e1-9258-58d7a39fbfb8"
excerpt: "이전에 만든 프로젝트를 vm에 배포할 것이다 그러기 위해서 서버를 먼저 설정한다 나중에 수정 사항은 줄이고 싶다면 프로젝트 끼리 연결 부분 먼저 한다"
description: "이전에 만든 프로젝트를 vm에 배포할 것이다 그러기 위해서 서버를 먼저 설정한다"
---

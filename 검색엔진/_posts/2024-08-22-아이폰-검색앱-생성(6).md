---
layout: post
image: "https://github.com/user-attachments/assets/36143e3d-b9b4-4b4f-84a7-88323771744b"
description: "엘라스틱 서치에 데이터를 저장했으니 검색 api를 통해서 데이터를 검색할 수 있다 그래서 이제 검색을 할 ios앱을 만들어야한다 앱은 간단히 메인 검색 페이지와 검색결과를 보여주는 리스트 페이지로 구성한다 결과에서 글의 제목을 클릭한다면 해당 공지사항이 있는 웹페이지로 이동한다"
---

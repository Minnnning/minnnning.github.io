...
tags: [ansible]
description: "Ansible은 Red Hat이 개발하고 관리하는 오픈소스 IT 자동화 도구임. 프로비저닝, 환경 설정, 애플리케이션 배포 등 수작업으로 진행하던 IT 업무를 코드 기반(IaC, Infrastructure as Code)으로 작성하여, 여러 시스템에 일관성 있게 적용할 수 있도록 돕는..."
---

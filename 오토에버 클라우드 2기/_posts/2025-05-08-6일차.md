...
image: "https://github.com/user-attachments/assets/f32b8f56-b9fd-4bb1-9967-32d7869d98df"
description: "입력 데이터를 이용해서 연산을 수행한 후 출력 값을 만들어 내는 개체 입력 데이터는 argument(parameter,매개변수,인수,인자등)라 하고 출력값을 return value 라고 한다"
---

...
2. 왼쪽 메뉴에서 **[사용자]**를 선택하고 **[사용자 생성]** 버튼을 클릭
   <center><img src="https://image.minnnningnas.duckdns.org/images/f6d44668-2e7c-4ef7-b7f5-29cfb0121c4b.webp" style="zoom:50%;"></center>
...
9. **[보안 자격 증명]** 탭으로 이동하여 **[액세스 키 만들기]** 버튼을 클릭
   <center><img src="https://image.minnnningnas.duckdns.org/images/fe570075-07a2-42d5-b10b-02fd56619859.webp" style="zoom:50%;"></center>
...
2. **[Settings]** 탭 > **[Secrets and variables]** > **[Actions]** 메뉴로 이동
   <center><img src="https://image.minnnningnas.duckdns.org/images/48340be9-b2cd-4079-96e6-f5db95258718.webp" style="zoom:30%;"></center>
...
2. **GitHub 리포지토리의 [Actions] 탭**으로 이동하면, 방금 푸시한 커밋으로 인해 워크플로우가 실행되는 것을 실시간으로 확인할 수 있다
   <center><img src="https://image.minnnningnas.duckdns.org/images/e9076348-b85d-49aa-b15f-81fa46d4ac82.webp" style="zoom:50%;"></center>

이제부터 `main` 브랜치에 코드를 `push`할 때마다 이 모든 과정이 자동으로 실행되어 웹사이트가 항상 최신 상태로 유지된다

<center><img src="https://image.minnnningnas.duckdns.org/images/4646a60b-15f5-4222-b676-833bab803e4f.webp" style="zoom:50%;"></center>

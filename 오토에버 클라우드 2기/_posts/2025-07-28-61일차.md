...
tags: [AWS, ECS]
image: 'https://image.minnnning.kr/images/a7955af3-38ec-4fbe-922f-50e7f902ee52.webp'
description: "Amazon ECS(Elastic Container Service)는 AWS 환경에 최적화된 완전 관리형 컨테이너 오케스트레이션 서비스 Docker 컨테이너를 AWS 클라우드에서 손쉽게 실행, 중지 및 관리할 수 있게 해주며, Docker Swarm이나 Kubernetes와 유사한..."
---
...
<details>
  <summary>서버리스란?</summary>
  서버리스(Serverless)는 '서버가 없다'는 뜻이 아니라, '개발자가 서버를 직접 관리할 필요가 없다'는 의미의 클라우드 컴퓨팅 모델 &nbsp; 개발자는 그저 컨테이너화된 애플리케이션(예: "이 Docker 이미지를 CPU 1개, 메모리 2GB로 실행해줘")만 ECS에 등록하면, Fargate가 보이지 않는 곳에서 알아서 최적의 서버를 할당하고, 실행하고, 관리해 준다
</details>
...
<center><img src="https://image.minnnning.kr/images/8b3a6d0f-7ea3-4e38-82e0-136c1db60ffa.webp" style="zoom:50%;"></center>

> 위 방법으로 멀티플랫폼으로 빌드를 하지 않고 그냥 빌드를 한다면 배포 하면서 아래 오류 발생
>
> <center><img src="https://image.minnnning.kr/images/80572966-743e-4e14-95ee-336a3a085317.webp" style="zoom:50%;"></center>

### 4-2. ECS 클러스터 생성

1. **ECS 서비스로 이동**하여 '클러스터' 메뉴에서 '클러스터 생성' 클릭

   <center><img src="https://image.minnnning.kr/images/5faeb62a-1763-4e90-a786-885ee0b55f5a.webp" style="zoom:30%;"></center>

2. **클러스터 이름** (예: `my-fargate-cluster`)을 입력

3. **인프라** 섹션에서 **AWS Fargate(서버리스)**를 선택하고 '생성'
   <center><img src="https://image.minnnning.kr/images/a1f4bc04-d90b-4cad-9b03-3143fd3b8342.webp" style="zoom:30%;"></center>

   **생성 실패 오류**

   위 과정을 하면 실패하는 경우가 발생(Service-Linked Role 오류)
   <center><img src="https://image.minnnning.kr/images/b59047a1-f659-4b4e-994b-5c74f624a073.webp" style="zoom:50%;"></center>
...
4. **작업 크기**: 작업에 할당할 **CPU(vCPU)**와 **메모리(GB)**를 지정. (예: 0.5 vCPU, 1 GB)
   ...
   <center><img src="https://image.minnnning.kr/images/8748504f-ca80-4205-864b-2e8b52ed4da6.webp" style="zoom:30%;"></center>
...
5. **컨테이너 세부 정보**:
   ...
   - **포트 매핑**: 호스트 포트는 비워두고, **컨테이너 포트**에 `80`을 입력
     <center><img src="https://image.minnnning.kr/images/baa0c8d7-e0f1-41ca-9eac-9c46afa49ee4.webp" style="zoom:30%;"></center>
...
- EC2 서비스의 '로드 밸런서' 메뉴로 이동하여 방금 생성된 ALB를 찾고, **DNS 이름**을 복사
  <center><img src="https://image.minnnning.kr/images/c448c87c-b79d-42ee-8722-22c7e0ec6e5d.webp" style="zoom:50%;"></center>

- 웹 브라우저 주소창에 이 DNS 이름을 붙여넣으면, 직접 작성한 `index.html`의 내용이 표시됨

<center><img src="https://image.minnnning.kr/images/a7955af3-38ec-4fbe-922f-50e7f902ee52.webp" style="zoom:50%;"></center>

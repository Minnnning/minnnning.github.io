...
image: "https://github.com/user-attachments/assets/d0ef6205-0d8f-4754-ad6b-48504a176b17"
description: "스위프트에는 버튼, 레이블, 슬라이더등 많은 뷰들이 존재한다 이 뷰들을 정렬하거나 크기를 정의하는데 사용하는 스택과 프레임을 사용한다"
---

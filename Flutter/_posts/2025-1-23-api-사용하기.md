...
tags: [flutter, api]
image: "https://github.com/user-attachments/assets/8c30a4f7-9906-44ab-9361-3beb7e9d3c39"
description: "HTTP기반의 api는 REST API, GraphQL, gRPC등이 존재한다 여기서 주로 사용하는것은 REST api를 이용한다 rest api에는 get, post, delete, put등 메서드를 이용한다 이 메서드들을 이요해서 CRUD 연산을 한다"
---

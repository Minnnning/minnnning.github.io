...
title: 앤서블 사용해보기
tags: [ansible]
description: "Ansible은 에이전트가 필요 없는(Agentless) 오픈소스 자동화 도구이다 SSH 프로토콜을 통해 원격 서버에 접속하여 소프트웨어 설치, 설정 변경, 서비스 관리 등 다양한 작업을 수행 YAML 형식의 플레이북(Playbook)을 사용하여 복잡한 작업들을 순서대로 쉽게 정의하고..."
---
